...
string Reason_hdr_comma_separated("Reason: SIP; cause=200; text=\"Call completed elsewhere\" , "
                                  "Q.850 ;cause=16 ;text=\"Terminated\"");

string Reason_hdr_new_header("Reason: SIP; cause=200; text=\"Call completed elsewhere\"\r\n"
...
TEST_F(YetiTest, ReasonParserCommaSeparatedFlatParams)
{
    ...
    ReasonParser p;
    p.parse_headers("Reason: SIP; cause=200; sparam1; sparam2=test; sparam3=\"test\"; "
                    "text=\"Call completed elsewhere\" , "
...
TEST_F(YetiTest, ReasonParserAddUnknown)
{
    ...
    ReasonParser p;
    p.parse_headers("Reason: SIP; cause=200; test; test2=test3;test4=\"test5\";text=\"Call completed elsewhere\" , "
...
TEST_F(YetiTest, ReasonParserNoCause)
{
    ...
    ReasonParser p;
    p.parse_headers("Reason: Q.850 ;text=\"Terminated\"");
...
TEST_F(YetiTest, ReasonParserNoText)
{
    ...
    ReasonParser p;
    p.parse_headers("Reason: Q.850 ;cause=16");
...
TEST_F(YetiTest, ReasonParserQ850Flat)
{
    ...
    ReasonParser p;
    p.parse_headers("Reason: Q.850;cause=31;text=\"Normal, unspecified\"");
...
TEST_F(YetiTest, ReasonParserSIPFlat)
{
    ...
    ReasonParser p;
    p.parse_headers("Reason: SIP;cause=200;text=\"Normal call clearing\"");
...
TEST_F(YetiTest, ReasonParserSIPFlatCauseBorderValues)
{
    ...
    ReasonParser p;
    p.parse_headers(R"-(Reason: SIP; cause=32767; text="Call completed elsewhere", )-"
...
TEST_F(YetiTest, ReasonParserSIPFlatCauseOutOfRange)
{
    ...
    ReasonParser p;
    p.parse_headers(R"-(Reason: SIP; cause=32768; text="Call completed elsewhere", )-"
