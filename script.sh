...
cat >>Dockerfile <<EOF
RUN apt-get install --yes --no-install-recommends --force-yes libsems1-dev libyeticc-dev libhiredis-dev libcurl3-dev libpqxx3-dev libspandsp-dev libprotobuf-dev protobuf-compiler
