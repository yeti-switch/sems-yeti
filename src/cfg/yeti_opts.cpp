...
#define YETI_CFG_RES_INIT_DEFAULT_MAX_DELAY 0
...
char opt_name_throttling_gateway_key[] = "throttling_gateway_key";
...
// routing
cfg_opt_t sig_yeti_routing_pool_opts[] = { db_opts, DCFG_INT(size), DCFG_INT(check_interval),
                                           DCFG_INT(statement_timeout), CFG_END() };

cfg_opt_t routing_headers_opts[] = { CFG_FUNC(opt_func_name_header, add_routing_header), CFG_END() };

cfg_opt_t sig_yeti_routing_opts[] = { VCFG_STR(schema, switch22),
                                      ...
                                      CFG_STR(opt_name_throttling_gateway_key, "", CFGF_NONE),
...
// cdr
cfg_opt_t sig_yeti_cdr_db_opts[] = { db_opts, CFG_END() };

cfg_opt_t sig_yeti_cdr_opts[] = { DCFG_BOOL(failover_to_slave),
                                  DCFG_INT(pool_size),
...
// resources
cfg_opt_t sig_yeti_redis_pool_opts[] = { CFG_STR_LIST(opt_redis_hosts, 0, CFGF_NODEFAULT),
...
cfg_opt_t sig_yeti_resources_opts[] = { CFG_BOOL(opt_resources_reject_on_error, cfg_false, CFGF_NONE),
                                        CFG_INT(opt_resources_initialization_max_delay,
                                                YETI_CFG_RES_INIT_DEFAULT_MAX_DELAY, CFGF_NONE),
...
cfg_opt_t legb_cdr_headers_opts[] = { CFG_FUNC(opt_func_name_header, add_bleg_cdr_header), CFG_END() };

cfg_opt_t legb_reply_cdr_headers_opts[] = { CFG_FUNC(opt_func_name_header, add_bleg_reply_cdr_header),
                                            CFG_BOOL(opt_name_cdr_headers_add_sip_reason, cfg_false, CFGF_NONE),
