...
#define DC_LEGA_RTP_TIMEOUT    125
...
#define DC_MEDIA_PROCESSING_ERROR 144
#define DC_REINVITE_ERROR_REPLY   145
#define DC_FIN_BEFORE_DB_RESPONSE 146
...
class CodesTranslator {
    ...
    bool apply_internal_code_translation(const icode &c, unsigned int &internal_code, string &internal_reason,
                                         unsigned int &response_code, string &response_reason);
  ...
  public:
    ...
    void rewrite_response(unsigned int code, const string &reason, unsigned int &out_code, string &out_reason,
                          int override_id = 0);
    bool stop_hunting(unsigned int code, int override_id = 0);
    bool translate_db_code(unsigned int icode, unsigned int &internal_code, string &internal_reason,
                           unsigned int &response_code, string &response_reason, int override_id = 0);
