...
SBCFactory::SBCFactory(const string &_app_name)
    ...
    , invite_pre_auth_rejects(stat_group(Counter, MOD_NAME, "auth_rejects")
                                  .addAtomicCounter()
                                  .addLabel("method", "INVITE")
                                  .addLabel("mechanism", "pre_auth"))
    , invite_auth_rejects(stat_group(Counter, MOD_NAME, "auth_rejects")
                              .addAtomicCounter()
                              .addLabel("method", "INVITE")
                              .addLabel("mechanism", "all"))
    ...
    , register_auth_rejects(stat_group(Counter, MOD_NAME, "auth_rejects")
                                .addAtomicCounter()
