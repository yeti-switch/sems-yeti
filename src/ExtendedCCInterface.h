...
class ExtendedCCInterface
{
  ...
  public:
	...
	virtual CCChainProcessing onDtmf(SBCCallLeg *call, AmDtmfEvent* e) { return ContinueProcessing;  };
	...
	virtual bool getSdpOffer(SBCCallLeg *call, AmSdp& offer) { return false; }
